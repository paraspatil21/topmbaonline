    ...
    window.appData.mbaSpecializations.forEach(specialization => {
        ...
        specCard.innerHTML = `
            ...
            <div class="degree-body">
                ...
                <button class="compare-btn" data-specialization-id="${specialization.id}" style="background: #fabd05; color: #002c5c;">
                    <i class="fas fa-search" style="color: #002c5c;"></i> Explore Programs
                </button>
            </div>
        `;
    ...
    compareButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (this.classList.contains('compared')) {
                this.innerHTML = '<i class="fas fa-check" style="color: #002c5c;"></i> Added';
                this.style.background = '#fabd05';
                showNotification('Program added to compare list!', 'success');
            } else {
                this.innerHTML = courseType === 'course' ? '<i class="fas fa-plus" style="color: #002c5c;"></i> Compare' : '<i class="fas fa-search" style="color: #002c5c;"></i> Explore Programs';
                this.style.background = '#fabd05';
...
function showNotification(message, type = 'info') {
    ...
    notification.className = `notification fixed top-4 right-4 z-50 px-6 py-3 rounded-lg shadow-lg transform transition-transform duration-300 ${type === 'success' ? 'bg-yellow-500' : 'bg-yellow-500'} text-gray-800`;
    notification.style.background = '#fabd05';
    notification.style.color = '#002c5c';
